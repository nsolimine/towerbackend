  ...
  return knex('expert').del()
    .then(() => {
      return knex('expert').insert([{
          ...
          url: 'https://www.youtube.com/watch?v=5qCQLyb0-mI',
          ...
          url: 'https://www.youtube.com/watch?v=okLDkcexiVg',
          ...
          url: 'https://www.youtube.com/watch?v=U75g2mDTXtA',
          ...
          url: 'https://www.youtube.com/watch?v=SkoPfV5tjWo',
